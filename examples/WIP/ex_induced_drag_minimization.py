...
generator = ml.Generator(recorder=recorder)
...
def define_base_config(caddee : cd.CADDEE):
    ...
    wing_coefficients = wing_geometry.stack_coefficients()
    generator.add_output(wing_coefficients)
    ...
    h_tail_coefficients = h_tail_geometry.stack_coefficients()
    generator.add_output(h_tail_coefficients)
